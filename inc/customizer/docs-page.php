...
new \Kirki\Section( 'docs_page', array(
...
Kirki::add_field( 'ultd__panel', [
    ...
    'priority'        => 10,
    'choices'         => [
        'docs-template-01' => ULTD_ASSETS_ASSETS . 'docs-template-01.png',
        // 'docs-template-02' => ULTD_ASSETS_ASSETS . 'docs-template-02.png',
    ],
    'active_callback' => [
        [
...
if ( !is_plugin_active( 'ultimatedoc-pro/ultimate-doc-pro.php' ) ) {
    ...
    Kirki::add_field( 'ultd__panel', [
        ...
        'section'  => 'docs_page',
        'default'  => '
			<img style="opacity:.6" src="' . ULTD_ASSETS_ASSETS . 'docs-template-02.png" alt="">
			',
        'priority' => 10,
		'active_callback' => [
			[
...
Kirki::add_field( 'ultd__panel', [
    ...
    'settings'        => 'header_top',
    'section'         => 'docs_page',
    'default'         => '<h3 style="padding:12px 0px; text-align: center; font-size: 16px; background:#ddd; color:#222; margin:0;">' . __( 'Doc Text', 'ultimate-doc' ) . '</h3>',
    'priority'        => 10,
    'active_callback' => [
        [
            'setting'  => 'docs_design_template',
...
Kirki::add_field( 'ultd__panel', [
    ...
    'section'         => 'docs_page',
    'default'         => '<h3 style="padding:12px 0px; text-align: center; font-size: 16px; background:#ddd; color:#222; margin:0;">' . __( 'Doc Header', 'ultimate-doc' ) . '</h3>',
    'priority'        => 10,
    'active_callback' => [
        [
            'setting'  => 'docs_design_template',
...
Kirki::add_field( 'ultd__panel', [
    ...
    'section'         => 'docs_page',
    'default'         => '<h3 style="padding:12px 0px; text-align: center; font-size: 16px; background:#ddd; color:#222; margin:0;">' . __( 'Doc Body', 'ultimate-doc' ) . '</h3>',
    'priority'        => 10,
    'active_callback' => [
        [
            'setting'  => 'docs_design_template',
...
Kirki::add_field( 'ultd__panel', [
    ...
    'js_vars'         => [
        [
            'element'  => '.ultd--main .ultd--site-main',
            'function' => 'css',
...
Kirki::add_field( 'ultd__panel', [
    ...
    'js_vars'         => [
        [
            'element'  => '.ultd--site-main .docs-wraper',
            'function' => 'css',
            'property' => 'background-color',
        ],
    ],
...
Kirki::add_field( 'ultd__panel', [
    ...
    'js_vars'         => [
        [
            'element'  => '.ultd--site-main .docs-wraper:hover',
            'function' => 'css',
            'property' => 'background-color',
        ],
    ],
...
Kirki::add_field( 'ultd__panel', [
    ...
    'section'         => 'docs_page',
    'default'         => '<h3 style="padding:12px 0px; text-align: center; font-size: 12px; background:#ddd; color:#222; margin:0;">' . __( 'Doc Content', 'ultimate-doc' ) . '</h3>',
    'priority'        => 10,
    'active_callback' => [
        [
            'setting'  => 'docs_design_template',
...
Kirki::add_field( 'ultd__panel', [
    ...
    'js_vars'         => [
        [
            'element'  => '.ultd--site-main .docs-wraper .card-top img',
            'function' => 'css',
            'property' => 'width',
            'units'    => '%',
        ],
...
Kirki::add_field( 'ultd__panel', [
    ...
    'js_vars'         => [
        [
            'element'  => '.ultd--site-main .card-bottom',
            'function' => 'css',
            'property' => 'background-color',
        ],
    ],
...
Kirki::add_field( 'ultd__panel', [
    ...
    'js_vars'         => [
        [
            'element'  => '.ultd--site-main .card-bottom .card-content-title h1',
            'function' => 'css',
            'property' => 'color',
        ],
    ],
...
Kirki::add_field( 'ultd__panel', [
    ...
    'js_vars'         => [
        [
            'element'  => '.ultd--site-main .card-bottom .card-content p',
            'function' => 'css',
            'property' => 'font-size',
            'units'    => 'px',
        ],
...
Kirki::add_field( 'ultd__panel', [
    ...
    'js_vars'         => [
        [
            'element'  => '.ultd--site-main .card-bottom:hover',
            'function' => 'css',
            'property' => 'background-color',
        ],
    ],
...
Kirki::add_field( 'ultd__panel', [
    ...
    'js_vars'         => [
        [
            'element'  => '.ultd--site-main .card-bottom .card-content-title h1:hover',
            'function' => 'css',
            'property' => 'color',
        ],
    ],
...
Kirki::add_field( 'ultd__panel', [
    ...
    'section'         => 'docs_page',
    'default'         => '<h3 style="padding:12px 0px; text-align: center; font-size: 12px; background:#ddd; color:#222; margin:0;">' . __( 'Doc Button', 'ultimate-doc' ) . '</h3>',
    'priority'        => 10,
    'active_callback' => [
        [
            'setting'  => 'docs_design_template',
...
Kirki::add_field( 'ultd__panel', [
    ...
    'js_vars'         => [
        [
            'element'  => '.ultd--site-main .card-bottom .card-button a',
            'function' => 'css',
            'property' => 'font-size',
            'units'    => 'px',
        ],
...
Kirki::add_field( 'ultd__panel', [
    ...
    'js_vars'         => [
        [
            'element'  => '.ultd--site-main .card-bottom .card-button a:hover',
            'function' => 'css',
            'property' => 'color',
        ],
    ],
...
Kirki::add_field( 'ultd__panel', [
    ...
    'section'         => 'docs_page',
    'default'         => '<h3 style="padding:12px 0px; text-align: center; font-size: 12px; background:#ddd; color:#222; margin:0;">' . __( 'Doc Item Counter', 'ultimate-doc' ) . '</h3>',
    'priority'        => 10,
    'active_callback' => [
        [
            'setting'  => 'docs_design_template',
...
Kirki::add_field( 'ultd__panel', [
    ...
    'js_vars'         => [
        [
            'element'  => '.ultd--site-main .docs-templatetwo .docs-article .docs-article-total',
            'function' => 'css',
            'property' => 'font-size',
            'units'    => 'px',
        ],
