<?php
new \Kirki\Section( 'doc_sidebar', array(
...
Kirki::add_field( 'ultd__panel', [
	...
	'js_vars'   => [
		[
			'element'  => '.ultd--single-wrap .ultd--sidebar',
			'function' => 'css',
...
Kirki::add_field( 'ultd__panel', [
	...
	'js_vars'   => [
		[
			'element'  => '.ultd--sidebar ul li a:hover',
			'function' => 'css',
			'property' => 'color',
			'suffix' => '!important',
		],
...
Kirki::add_field( 'ultd__panel', [
	...
	'js_vars'   => [
		[
			'element'  => '.ultd--sidebar ul li ul.children li a',
			'function' => 'css',
			'property' => 'font-size',
			'units'    => 'px',
			'suffix' => '!important',
...
Kirki::add_field( 'ultd__panel', [
	...
	'js_vars'   => [
		[
			'element'  => '.ultd--sidebar ul li ul.children li a:hover',
			'function' => 'css',
			'property' => 'color',
			'suffix' => '!important',
		],
...
Kirki::add_field( 'ultd__panel', [
	...
	'settings'    => 'icon_box',
	'section'     => 'doc_sidebar',
		'default'         => '<h3 style="padding:12px 0px; text-align: center; font-size: 16px; background:#ddd; color:#222; margin:0;">' . __( 'Icon', 'ultimate-doc' ) . '</h3>',
	'priority'    => 10,
] );
...
Kirki::add_field( 'ultd__panel', [
	...
	'js_vars'   => [
		[
			'element'  => '.ultd--sidebar ul.ultd--nav-list li a span.dashicons',
			'function' => 'css',
			'property' => 'font-size',
			'units'    => 'px'
		],
...
Kirki::add_field( 'ultd__panel', [
	...
	'section'     => 'doc_sidebar',
		'default'         => '<h3 style="padding:12px 0px; text-align: center; font-size: 16px; background:#ddd; color:#222; margin:0;">' . __( 'Responsive Menu', 'ultimate-doc' ) . '</h3>',
	'priority'    => 10,
] );
...
Kirki::add_field( 'ultd__panel', [
	...
	'js_vars'   => [
		[
			'element'  => '.ultd--sidebar #mainnav>.ultd--sidebar-trigger',
			'function' => 'css',
			'property' => 'color',
		],
	]
...
Kirki::add_field( 'ultd__panel', [
	...
	'js_vars'   => [
		[
			'element'  => '.ultd--sidebar #mainnav>.ultd--sidebar-trigger span.dashicons.dashicons-menu',
			'function' => 'css',
			'property' => 'font-size',
			'units'    => 'px'
		],
...
Kirki::add_field( 'ultd__panel', [
	...
	'js_vars'   => [
		[
			'element'  => '.ultd--sidebar #mainnav .ultd--nav-inner .ultd--sidebar-trigger',
			'function' => 'css',
			'property' => 'color',
		],
	]
...
Kirki::add_field( 'ultd__panel', [
	...
	'js_vars'   => [
		[
			'element'  => '.ultd--sidebar #mainnav .ultd--nav-inner .ultd--sidebar-trigger span.dashicons.dashicons-no-alt',
			'function' => 'css',
			'property' => 'font-size',
			'units'    => 'px'
		],
